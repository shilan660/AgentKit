...
def list_knowledge_base() -> dict:
    ...
    url = build_kb_api_url(BYTEHOUSE_HOST, 'knowledge-base/list')
...
def main():
    ...
    _ = argparse.ArgumentParser(
        description='ByteHouse 知识库列表查询工具',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
示例:
  # 查询所有知识库列表
  python3 list_knowledge_base.py
