...
def delete_knowledge_base(kb_id: int) -> dict:
    ...
    url = build_kb_api_url(BYTEHOUSE_HOST, 'knowledge-base/delete')
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='ByteHouse 知识库删除工具',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
示例:
  # 删除指定知识库
  python3 delete_knowledge_base.py --kb-id 123
...
'''
    ...
    parser.add_argument('--kb-id', type=int, required=True, help='指定要删除的知识库ID（必填）')
