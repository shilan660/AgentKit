...
ERROR_MAP = {
    ...
    "RequestParametersError": "请求参数错误: 请检查接口必填字段是否齐全 (如 OpenCreateTts 的 Name/TtsTemplateContent/Lang, SingleBatchAppend 的 Phone/Resource/NumberPoolNo).",
...
def call_top(action: str, params: Dict[str, Any], *,
    ...
    if is_get:
        ...
        body = "&".join(f"{parse.quote(str(k), safe='')}={parse.quote(str(v), safe='')}"
