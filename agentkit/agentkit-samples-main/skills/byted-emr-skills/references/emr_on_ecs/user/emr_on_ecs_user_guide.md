...
| Password | String | 是 | xxx               | 要新建的用户的登录密码。 密码的长度需在8-20个字符之间，支持数字，字母，-，_ 且 至少包含1个数字和1个字母。 |
...
python ./scripts/on_ecs/emr_on_ecs_cli.py \
  ...
  --body '{"ClusterId":"emr-xxx","UserName":"emr_user","Password":"xxx"}'
```
...
| OldPassword | String | 是 | xxx                     | 原有用户密码 |
| NewPassword | String | 是 | xxx                     | 新的用户密码 |
...
python ./scripts/on_ecs/emr_on_ecs_cli.py \
  ...
  --body '{"ClusterId":"emr-xxx","UserName":"emr_user","OldPassword":"xxx","NewPassword":"xxx"}'
```
